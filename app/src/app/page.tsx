  ...
  const domainTab2 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        />
        <ActionMemo
          persona={{ name: 'Malaysia Operations Lead', role: 'Director of Capacity' }}
          context={{}}
          onGenerate={async () => ({
            subject: 'Action Required',
            body: 'AI-generated recommendation based on current data patterns and predicted trends.',
            urgency: 'HIGH',
            actions: ['Review top quality defects findings', 'Optimize fab allocation', 'Prepare quarterly capacity report'],
          })}
        />
      </div>
    </div>
